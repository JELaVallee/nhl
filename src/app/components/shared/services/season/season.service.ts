...
export const SEASON_DATA: Season[] = [
  ...
  { name: '2016-2017-playoffs', start: new Date(2017, 3, 12), end: new Date(2017, 5, 11) },
  { name: '2016-2017-regular', start: new Date(2016, 9, 12), end: new Date(2017, 3, 11) },
  { name: '2015-2016-playoffs', start: new Date(2016, 3, 3), end: new Date(2016, 5, 12) },
  { name: '2015-2016-regular', start: new Date(2015, 9, 7), end: new Date(2016, 3, 2) },
  { name: '2014-2015-playoffs', start: new Date(2015, 3, 15), end: new Date(2015, 5, 15) },
  { name: '2014-2015-regular', start: new Date(2014, 9, 8), end: new Date(2015, 3, 14) },
  { name: '2013-2014-playoffs', start: new Date(2014, 3, 16), end: new Date(2014, 5, 13) },
  { name: '2013-2014-regular', start: new Date(2013, 9, 1), end: new Date(2014, 3, 15) },
  { name: '2012-2013-playoffs', start: new Date(2013, 3, 30), end: new Date(2013, 5, 24) },
  { name: '2012-2013-regular', start: new Date(2013, 0, 19), end: new Date(2013, 3, 29) },
  { name: '2011-2012-playoffs', start: new Date(2012, 3, 11), end: new Date(2012, 5, 11) },
  { name: '2011-2012-regular', start: new Date(2011, 9, 6), end: new Date(2012, 3, 10) },
  { name: '2010-2011-playoffs', start: new Date(2011, 3, 13), end: new Date(2011, 5, 15) },
  { name: '2010-2011-regular', start: new Date(2010, 9, 7), end: new Date(2011, 3, 12) },
  { name: '2009-2010-playoffs', start: new Date(2010, 3, 14), end: new Date(2010, 5, 9) },
  { name: '2009-2010-regular', start: new Date(2009, 9, 1), end: new Date(2010, 3, 13) },
  { name: '2008-2009-playoffs', start: new Date(2009, 3, 15), end: new Date(2009, 5, 12) },
  { name: '2008-2009-regular', start: new Date(2008, 9, 4), end: new Date(2009, 3, 14) },
  { name: '2007-2008-playoffs', start: new Date(2008, 3, 9), end: new Date(2008, 5, 4) },
